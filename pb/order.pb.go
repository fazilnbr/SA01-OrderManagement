...
type FetchOrderResponse struct {
	...
	Status int32  `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Orders *Order `protobuf:"bytes,3,opt,name=orders,proto3" json:"orders,omitempty"`
}
...
var file_pb_order_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x6f, 0x72, 0x64,
